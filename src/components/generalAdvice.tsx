...
const GeneralAdvice = () => {
    return (
        <div>
       <div>
        <h2>Biovore Spore Mine</h2>
        <ul>
          <li>What secondaries can you score, this turn or next</li>
          <li>What units can you block movement.</li>
          <li>Use Spore Mines to block deep strike and charge lanes.</li>
          <li>Bait your opponent into making mistakes.</li>
          </ul>
       </div>
<div>   
      <h2>Trade Wars</h2>
...
<ul>
  ...
  <li></li>
      ...
      <div>
        <h2>Lone Ops</h2>
        <ul>
  <li>Deploy/move them on the very edge of an objective.</li>
  <li>Force your opponent to deal with them.</li>
  <li>Have one of your threats behind cover or close by to counter punch.</li>
</ul>
      </div>
